...
let elProduct = document.querySelector('.products');
let elButton = document.querySelectorAll('button');
elButton.forEach(function (currentButton) {
...
function showCategory(category) {
    ...
    elProduct.insertAdjacentHTML('afterbegin', getProductMarkup(products[category]));
