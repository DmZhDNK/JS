...
elNavLink.forEach(function (currentEl) {
...
function changeText(event) {
    if (event.textContent == 'Link 1') {
        elText.innerHTML = texts.text1;
        return;
    };
    if (event.textContent == 'Link 2') {
        elText.innerHTML = texts.text2;
        return;
    };
    if (event.textContent == 'Link 3') {
        elText.innerHTML = texts.text3;
    };
};